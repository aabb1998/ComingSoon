  ...
  return (
    <>
      <Layout title="Alihsan Foundation USA">
        ...
        <span className="my-10 md:w-6/12 w-11/12 text-center text-sm font-bold">
          Al- Ihsan foundation USA is a non-profit tax-exempt organization (with
          Tax-ID: 92-3318902) For humanitarian aid and relief. It is registered
          with the Internal Revenue Service under revenue code 501(c)(3).
        </span>
      </Layout>
    </>
  );
